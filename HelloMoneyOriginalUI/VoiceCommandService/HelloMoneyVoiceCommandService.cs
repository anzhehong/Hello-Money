...
namespace HelloMoney.VoiceCommands
{
    ...
    /// </summary>
    public sealed class HelloMoneyVoiceCommandService : IBackgroundTask
    {
        /// <summary>
        ...
        public async void Run(IBackgroundTaskInstance taskInstance)
        {
            ...
            if (triggerDetails != null && triggerDetails.Name == "HelloMoneyVoiceCommandService")
            {
                try
                {
        ...
        private async void LaunchAppInForeground()
        {
            ...
            userMessage.SpokenMessage = cortanaResourceMap.GetValue("LaunchingHelloMoney", cortanaContext).ValueAsString;
